  ...
  if (currentScreen === 'dense outbreak'|| currentScreen === 'sparse outbreak'){
    if (keyCode === LEFT_ARROW) {
      ...
      if (currentScreen == "dense outbreak"){
        newSelected = dPmfGraph.cursorOver()-1;
        dPmfGraph.setSelection(newSelected);
      }
      else{
        newSelected = sPmfGraph.cursorOver()-1;
        sPmfGraph.setSelection(newSelected);
      }
      ...
      if (currentScreen == "dense outbreak"){
        dPmfGraph.setSelection(-1);
      }
      else{
        sPmfGraph.setSelection(-1);
      }
    }
  }
};